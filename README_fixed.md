...
- `bhajan_app_fixed.py` (galvenā aplikācijas faila)
...
```bash
streamlit run bhajan_app_fixed.py
```
...
Jūsu `Bhajans.xlsx` failam jābūt šādām kolonnām:
...
3. Izveidojiet jaunu aplikāciju:
   ...
   - **Branch:** `main`  
   - **Main file path:** `bhajan_app_fixed.py`
4. Nospiediet "Deploy!"
...
### Dizaina maiņa
CSS stili ir definēti `bhajan_app_fixed.py` failā. Varat pielāgot:
- Krāsas
- Fontus
- Izliktum
- Animācijas
...
- **v1.0** - Pamata funkcionalitāte ar fiksētu datu failu
- **v1.1** - Uzlabots mobilais dizains 
- **v1.2** - Pievienota statistika un labāka navigācija
